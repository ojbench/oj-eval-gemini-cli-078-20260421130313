...
def main():
    ...
    submit_code_parser = subparsers.add_parser("submit-code", help="Submit source code directly")
    submit_code_parser.add_argument("--problem-id", type=int, required=True, help="Problem ID")
    submit_code_parser.add_argument("--language", type=str, default="C++", help="Language")
    submit_code_parser.add_argument("--file", type=str, required=True, help="Source code file")
